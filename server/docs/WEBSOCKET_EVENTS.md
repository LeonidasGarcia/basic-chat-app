...
Ack:
```json
{ "messageId": "<uuid>", "createdAt": "2026-01-01T00:00:00.000Z", "clientMessageId": "optional-local-id" }
```
...
Payload:
```json
{ "code": "UNIDENTIFIED", "message": "Call auth:identify before sending messages." }
```
